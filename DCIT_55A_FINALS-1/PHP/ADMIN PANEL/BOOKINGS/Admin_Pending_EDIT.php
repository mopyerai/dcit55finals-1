...
<body>
      <a href="Admin_Pending.php" class="back-button">← Back</a>
  <div class="edit-booking-page">
   
    <form action="Admin_Pending_UPDATE.php" method="POST" class="form-container">
           <div class="euser">  <h2>Edit Booking</h2></div><br>
